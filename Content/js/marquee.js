...
function marqueeInit(config) {
	...
	Marq.prototype.setup = function(c) {
		...
		this.m[1].style.left = this.w-80 + 'px';
	...
	Marq.prototype.runit = function() {
		...
		if(d * parseInt(this.m[0].style.left) >= this.w)
			this.m[0].style.left = parseInt(this.m[1].style.left)-80 - d * this.w + 'px';
		if(d * parseInt(this.m[1].style.left) >= this.w)
			this.m[1].style.left = parseInt(this.m[0].style.left)-80 - d * this.w + 'px';
	...
	Marq.prototype.directspeed = function(e) {
		...
		var c = this.c, w = c.offsetWidth, l = c.offsetLeft, mp = ( typeof e.pageX === 'number' ? e.pageX : e.clientX + document.body.scrollLeft + document.documentElement.scrollLeft) - l, lb = (w - this.r) / 2, rb = (w + this.r) / 2;
